...
///  Ussama Iftikhar on 21-July-2021.
...
class SessionController extends ValueNotifier<AgoraSettings> {
  ...
  Future<void> initializeEngine(
    ...
    value = value.copyWith(
      engine: await RtcEngine.create(agoraConnectionData.appId),
  ...
  Future<void> joinVideoChannel() async {
    ...
    if (value.connectionData!.tokenUrl != null) {
      ...
      await value.engine?.joinChannelWithUserAccount(
  ...
  Future<String> userName({int? uid}) async => value.engine!.getUserInfoByUid(uid!).then((value) {
      return value.userAccount.toString();
    });
