...
class _FloatingLayoutState extends State<FloatingLayout> {
  ...
  Widget _getRemoteViews(int uid, var name) {
    return Container(
      child: Column(
        children: [
          Text(name.toString(),style: TextStyle(color: Colors.red),),
                        ...
                        child: Column(
                          children: [
                            _videoView(_getRemoteViews(widget.client
                                .sessionController.value.mainAgoraUser.uid,widget.client
                                .sessionController.userName(uid: widget.client
